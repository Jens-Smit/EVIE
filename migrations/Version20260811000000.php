...
final class Version20260811000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // --- tool_definitions -------------------------------------------
        $this->addSql('CREATE TABLE tool_definitions (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, schema JSON NOT NULL, category_id INT DEFAULT NULL, complexity INT NOT NULL, dependencies JSON DEFAULT NULL, security_level VARCHAR(50) NOT NULL, requires_hitl BOOLEAN NOT NULL, metadata JSON DEFAULT NULL, status VARCHAR(50) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, executor_type VARCHAR(50) DEFAULT NULL, executor_config JSON DEFAULT NULL, security_policy JSON DEFAULT NULL, hitl_policy JSON DEFAULT NULL, version VARCHAR(50) DEFAULT NULL, user_identifier VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
