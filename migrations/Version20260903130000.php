...
final class Version20260903130000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9A04432EA76ED395 ON organization_users (user_id)');
        $this->addSql('ALTER TABLE organization_users ADD CONSTRAINT FK_9A04432E32C8A3DE FOREIGN KEY (organization_id) REFERENCES organizations (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE organization_users ADD CONSTRAINT FK_9A04432EA76ED395 FOREIGN KEY (user_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
